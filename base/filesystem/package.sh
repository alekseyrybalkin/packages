...
kiin_install() {
  ...
  # for multimedia and backups
  mkdir -pv ${pkgdir}/var/{multimedia,backups}
  chown ${PACMAN}:${PACMAN} ${pkgdir}/var/{multimedia,backups}
  chmod 700 ${pkgdir}/var/{multimedia,backups}
}
